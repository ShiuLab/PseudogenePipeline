#This version was modified by David E. Hufnagel on Jan 16, 2013.
#New attributes:
#    *can handle "#" info lines in fasta files
#    *can handle lowercase nucleotides
#    *can handle N's
import sys,re
...
countSeq = 0
while inl != "":
	if inl[0] == "#" and not inl.startswith("#python"):
		...
		#account for lowercase nucleotides (David E. Hufnagel Jan 14, 2013)
		nt2 = nt2.replace("a","A")
		nt2 = nt2.replace("t","T")
		nt2 = nt2.replace("c","C")
		nt2 = nt2.replace("g","G")
