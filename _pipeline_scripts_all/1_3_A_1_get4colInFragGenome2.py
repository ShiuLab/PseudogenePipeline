...
#fragmented genome, but only if the protein is fully enclosed by a contig
#for use in the pseudogene pipeline
        ...
        if oldChromo.strip("At") in refDict:
            ...
            for tup in refDict[oldChromo.strip("At")]:
                ...
                if oldProtStart > oldContStart and oldProtStart < oldContStop\
                   and oldProtStop > oldContStart and oldProtStop < oldContStop:
