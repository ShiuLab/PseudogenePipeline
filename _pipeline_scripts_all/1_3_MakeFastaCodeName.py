...
spe = sys.argv[2]            #2 char species Id
out = open(sys.argv[3], "w") #output fasta file with shortened names
ref = open(sys.argv[4], "w") #2 col reference file with code name and original name
