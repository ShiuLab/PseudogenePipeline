...
# Process Maker tblastn to tabular format
...
original_protein = {}
original_contig = {}
if protein_coverage < 0.99 or contig_converage < 0.99:
    ...
    if protein_spaces_coverage > 0.01 or contig_spaces_coverage > 0.01:
...
print "Calculating intron length distribution [" + FormatTime(time.time() - start_timer) + "]"
...
#print" Final output: %s.pairs.sw.out.disable_count" % ps1
