...
class file_util:
    ...
    def merge_list(self,file1,file2):
        ...
        while inl != "":
            ...
            oup.write(inl)
            inl = inp.readline()
        print(" %i entries" % len(list(mdict.keys())))
    ...
    def del_line(self,target,name):     
        ...
        print("Total %i names to delete" % len(list(ndict.keys())))
    ...
    def mark_line(self,target,name):        
        # generate a name dict
        ndict = self.file_to_dict(name,0)
        print("Total %i names to mark" % len(list(ndict.keys())))
    ...
    def select2(self,target,names,outfile,strStrip=0):
        ...
        print(" %i names" % len(list(names.keys())))
