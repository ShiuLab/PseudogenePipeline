...
out1_name = sys.argv[1]+".%iCutoff%.1fdivg.4col"%(thresh,div)
out1=open(out1_name,'w')

# 5/11/22: In case there is no repeat detected or to rid of header
file1.readline()        # Skip 1st line
...
out2_name = sys.argv[1]+".%iCutoff%.1fdivg.types"%(thresh,div)
...
print("  output 1:", out1_name)
print("  output 2:", out2_name)
