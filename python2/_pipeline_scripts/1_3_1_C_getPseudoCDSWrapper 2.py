...
#WARNING: DESIGNED TO DEAL WITH THE FACT THAT THE REF FILE WILL HAVE NAMES LIKE "At000001" INSTEAD OF "PsAt000001_AT4G05095" AS IT SHOULD BE.
...
four = sys.argv[3]      #input 4col pseudogene file with original names
...
#TO DO: disable_count file cannot have an extra info line
